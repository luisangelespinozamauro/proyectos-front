...
import AddPermisos from "../../Moduls/Permisos/AddPermisos";
...
export default function TablePermisos({ rows = [] }) {
  ...
  const [id_permiso, saveIdPermiso] = useState(null);
  ...
  return (
    <>
      ...
      <AddPermisos open={modalAdd} handleClose={handleClickCloseAdd} />
    </>
  );
}
